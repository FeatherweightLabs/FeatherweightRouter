 ...
 */
public struct RoutePresenter<ViewController> {
    
    /// Returns the child presenter
    public var getPresentable: (RouteArguments) -> ViewController
    ...
    /**
     ...
     - parameter setRouteOptions: Callback to parametrize presenter with route options
     */
    public init(getPresentable: @escaping (RouteArguments) -> ViewController,
...
public typealias RouteArguments = [String]
