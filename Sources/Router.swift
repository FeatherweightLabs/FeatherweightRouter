...
public struct Router<ViewController, Path> {
     ...
     */
    public var presenter: RoutePresenter<ViewController>
    
    /**
     The presenter to return if this route matches
     */
    //    public var presentable: ViewController { return presenter.presentable }
    public func getPresentable(options: RouteArguments? = nil) -> ViewController {
        return presenter.getPresentable(options ?? [])
    }
    ...
    /**
     Passes route options to presenter
     */
    public var setRouteOptions: (Path) -> RouteArguments? = { _ in nil }
     ...
     */
    public init(
        _ presenter: RoutePresenter<ViewController>,
